...
import { CheckCircle2, Globe, Users, ShieldCheck, Zap, Shield, Clock, ChevronDown } from 'lucide-react';
...
const faqs = [
    {
        question: "Do your project managers have certifications?",
        answer: "Yes, many of our PMs are PMP, CSM, or Prince2 certified, with years of real-world leadership experience."
    },
    {
        question: "Can they manage distributed teams?",
        answer: "Our experts are specialized in managing remote and hybrid teams across multiple time zones using modern collaboration tools."
    }
];
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="max-w-xl">
                            ...
                            <p className="mt-8 text-lg text-gray-600 leading-relaxed">
                                Deliver your projects on time and under budget with world-class Agile Project Managers, Scrum Masters, and Program Managers.
                            </p>
            ...
            <section className="py-24 bg-white overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-[#1a1a2e]">Proven Project Leadership</h2>
                        <p className="mt-4 text-gray-600">Hire project leaders for Agile, Waterfall, and hybrid environments.</p>
                    </div>
            ...
            <section className="py-24 bg-[#f8faff]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-3 gap-12">
                        {[
                            { icon: ShieldCheck, title: "Structured Success", desc: "Our PMs bring proven methodologies and frameworks to ensure clarity and accountability across your teams." },
                            { icon: Zap, title: "Efficiency First", desc: "Unblock your teams and optimize workflows to increase delivery velocity without sacrificing quality." },
                            { icon: Shield, title: "Strategic Alignment", desc: "Ensure every task contributes to your high-level business goals through meticulous planning and execution." }
                        ].map((benefit, idx) => (
