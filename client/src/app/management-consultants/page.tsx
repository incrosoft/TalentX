...
import { CheckCircle2, Globe, Briefcase, ShieldCheck, Zap, Shield, Users, Clock, ChevronDown } from 'lucide-react';
...
const faqs = [
    {
        question: "What industries do your consultants cover?",
        answer: "Our consultants have deep expertise across Finance, Tech, Healthcare, Energy, and Retail."
    },
    {
        question: "Can I hire for a specific business challenge?",
        answer: "Yes, we match you with specialists who have successfully solved similar organizational or strategic challenges."
    }
];
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="max-w-xl">
                            ...
                            <p className="mt-8 text-lg text-gray-600 leading-relaxed">
                                Transform your business with world-class strategy, operations, and financial experts. Our consultants are alumni of the top global firms.
                            </p>
            ...
            <section className="py-24 bg-white overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-[#1a1a2e]">Strategic Expertise for Every Challenge</h2>
                        <p className="mt-4 text-gray-600">Hire elite consultants for strategy, finance, and operations.</p>
                    </div>
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                        {skills.map((skill, idx) => (
                            <div key={idx} className="p-6 border border-gray-100 rounded-sm hover:shadow-lg transition-all text-center group cursor-pointer">
                                <Briefcase className="w-8 h-8 text-blue-500 mx-auto mb-3 group-hover:scale-110 transition-transform" />
            ...
            <section className="py-24 bg-[#f8faff]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-3 gap-12">
                        {[
                            { icon: ShieldCheck, title: "Elite Pedigree", desc: "Our consultants come from top-tier firms and global companies, bringing proven frameworks and insights." },
                            { icon: Zap, title: "Operational Excellence", desc: "We focus on actionable results, not just reports, helping you implement and sustain change." },
                            { icon: Shield, title: "Deep Expertise", desc: "Connect with specialists who have deep domain knowledge in your specific industry or functional area." }
                        ].map((benefit, idx) => (
