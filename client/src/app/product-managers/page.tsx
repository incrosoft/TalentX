...
import { CheckCircle2, Globe, Target, ShieldCheck, Zap, Shield, Users, Clock, ChevronDown } from 'lucide-react';
...
const faqs = [
    {
        question: "How do you define a top 10% product manager?",
        answer: "Our PMs have a proven track record of shipping successful products, managing complex cross-functional teams, and driving business growth."
    },
    {
        question: "Can they help with product strategy from scratch?",
        answer: "Yes, we have experts who specialize in early-stage discovery, MVP definition, and zero-to-one product development."
    }
];
    ...
    return (
        <main className="min-h-screen bg-white">
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="max-w-xl">
                            ...
                            <p className="mt-8 text-lg text-gray-600 leading-relaxed">
                                Build better products with world-class Product Managers, Product Strategists, and Technical PMs from top tech companies.
                            </p>
            ...
            <section className="py-24 bg-white overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-[#1a1a2e]">Strategic Product Leadership</h2>
                        <p className="mt-4 text-gray-600">Hire product leaders who bridge the gap between business and technology.</p>
                    </div>
            ...
            <section className="py-24 bg-[#f8faff]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-[#1a1a2e]">Why Top Companies Choose TalentX Product Managers</h2>
                    </div>
                    <div className="grid md:grid-cols-3 gap-12">
                        {[
                            { icon: ShieldCheck, title: "Product Mindset", desc: "Our PMs bring a deep understanding of user needs, business goals, and technical constraints to build winning products." },
                            { icon: Zap, title: "Execution Focused", desc: "We focus on high-velocity delivery and iterative improvement to get your product to market faster." },
                            { icon: Shield, title: "Market Insight", desc: "Work with experts who have deep knowledge of your target market and competitive landscape." }
                        ].map((benefit, idx) => (
