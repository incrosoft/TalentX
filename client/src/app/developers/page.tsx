...
const faqs = [
    {
        question: "How does the no-risk trial work?",
        answer: "If you're not satisfied with a developer within the first two weeks, you don't pay. We'll find you a better replacement or you can walk away."
    },
    {
        question: "How long does it take to hire a developer?",
        answer: "In most cases, we introduce you to hand-selected candidates within 48 hours. Many of our clients start working with a developer in under a week."
    },
    {
        question: "What is your vetting process?",
        answer: "We test for language & communication, core technical skills, and deep domain expertise. Only about 3% of applicants make it through our rigorous screening."
    },
    {
        question: "Can I hire a full team?",
        answer: "Yes, we can help you build cross-functional teams including designers, product managers, and project managers along with developers."
    }
];
...
export default function DevelopersPage() {
    ...
    return (
        <main className="min-h-screen bg-white">
            ...
            {/* FAQ Section with Custom Implementation */}
