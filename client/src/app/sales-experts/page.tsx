...
import { CheckCircle2, Globe, Rocket, ShieldCheck, Zap, Shield, Users, Clock, ChevronDown, Target } from 'lucide-react';
...
const faqs = [
    {
        question: "How do you vet your sales experts?",
        answer: "We focus on proven revenue growth, pipeline management skills, and experience with complex sales cycles in specific industries."
    },
    {
        question: "Can they help with sales strategy?",
        answer: "Yes, our experts can help build out your sales playbook, define territories, and set up your entire sales stack."
    }
];
    ...
    return (
        <main className="min-h-screen bg-white">
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="max-w-xl">
                            ...
                            <p className="mt-8 text-lg text-gray-600 leading-relaxed">
                                Scale your revenue with world-class Sales Representatives, Account Executives, and Sales Leaders from the world's most successful companies.
                            </p>
            ...
            <section className="py-24 bg-white overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-[#1a1a2e]">Dynamic Sales Expertise</h2>
                        <p className="mt-4 text-gray-600">Hire sales professionals to accelerate your entire sales funnel.</p>
                    </div>
            ...
            <section className="py-24 bg-[#f8faff]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-[#1a1a2e]">Why Top Companies Choose TalentX Sales Experts</h2>
                    </div>
                    <div className="grid md:grid-cols-3 gap-12">
                        {[
                            { icon: ShieldCheck, title: "Revenue Focused", desc: "Our experts are driven by measurable outcomes and have a track record of exceeding sales targets." },
                            { icon: Zap, title: "Industry Insight", desc: "Work with sales professionals who understand your specific market and customer pain points." },
                            { icon: Shield, title: "Process Excellence", desc: "Ensure your sales organization is built for scale with experts who bring operational discipline and modern playbooks." }
                        ].map((benefit, idx) => (
