...
const talents = [
  {
    ...
    rating: 98,
    previous: "Apple & Google",
  },
  {
    name: "Michael Rodriguez",
    role: "Frontend Engineer",
    image:
      "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=800&h=900&fit=crop",
    rating: 95,
    previous: "Meta & Spotify",
  },
  {
    name: "Amina Hassan",
    role: "Backend Engineer",
    image:
      "https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?w=800&h=900&fit=crop",
    rating: 94,
    previous: "Amazon & Stripe",
  },
  {
    name: "Daniel Kim",
    role: "Product Manager",
    image:
      "https://images.unsplash.com/photo-1547425260-76bcadfb4f2c?w=800&h=900&fit=crop",
    rating: 96,
    previous: "Netflix & Airbnb",
  },
];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              ...
              <Link href={createPageUrl("ApplyTalent")}>
                <Button
                  variant="outline"
                  className="h-14 px-8 text-lg border-2 border-gray-200 hover:border-primary hover:text-primary hover:bg-transparent transition-all duration-300"
                >
                  Apply as a Talent
                </Button>
              </Link>
          ...
          >
            ...
            <motion.div
              ...
              className="absolute z-50 -right-11 top-20 bg-white rounded-xl shadow-xl p-6 border border-gray-100 max-w-[200px]"
            >
              ...
              {talents.map((talent, index) => (
                <SwiperSlide key={index}>
                  <motion.div
                    ...
                    transition={{ duration: 0.5 }}
                    className="relative rounded-2xl overflow-hidden shadow-2xl shadow-gray-200/50 border border-white/50"
                  >
                    <img
                      src={talent.image}
                      alt={talent.name}
                    ...
                    {/* Top Info - Available Now + Stars */}
                    <div className="absolute z-50 bottom-33 left-6 flex gap-2 text-white ">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                      <h3 className="text-3xl font-bold mb-1">{talent.name}</h3>
